...
# ====================================================================
# 2. DEFINE CUSTOM LAYER & LOAD MODEL
# ====================================================================
# Define the custom attention layer class from your training notebook
...
@st.cache_resource
def load_fer_model():
    # Pass the custom layer in custom_objects so Keras knows how to deserialize it
...
if st.button("📊 Render Session Analytics Graphs", use_container_width=True):
    ...
    if len(ts) > 0:
        ...
        st.warning("No data recorded yet. Please turn on your camera stream.")